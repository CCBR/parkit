...
- Added Helix host and resilient-session preflight checks (`tmux`/`screen`).
...
- `projark --version`, `projark deposit --version`, and `projark retrieve --version` provide the same package-aware version output.
